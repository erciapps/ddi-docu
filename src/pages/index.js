...
export default function Home() {
  ...
  return (
    <Layout
      title="DDI · Desarrollo de Interfaces"
      description="Portal principal del recurso DDI (Desarrollo de Interfaces)">
      {/* Fondo global */}
      <div style={{
        minHeight:'100vh',
        color:'#e2e8f0',
        ...
        <header style={{
          ...
          <h1 style={{margin:'0 0 6px', fontSize:'clamp(28px,3vw,40px)', letterSpacing:'.3px'}}>
            📱🖌️ DDI — Desarrollo de Interfaces
          </h1>
        ...
        <section style={{
          ...
          {/* Guía rápida */}
          <article className="lift-card" style={cardStyle('#0a1930','#0d47a1','#1976d2')}>
            <div className="glow" style={glowStyle}></div>
            <span style={pill('#38bdf8')}>Inicio</span>
            <h3 style={title}>Guía rápida</h3>
            <p style={desc}>
              Requisitos, setup, estructura de carpetas, y cómo empezar.
            </p>
            <a href="/docs/intro" style={btn('#1976d2')}>Ver guía <span style={arrow}>→</span></a>
          </article>

          {/* Temario */}
          <article className="lift-card" style={cardStyle('#0a1930','#0d47a1','#1976d2')}>
            <div className="glow" style={glowStyle}></div>
            <span style={pill('#38bdf8')}>Docs</span>
            <h3 style={title}>Temario</h3>
            <p style={desc}>
              Contenidos organizados por unidades: XAML, estilos, MVVM, componentes, accesibilidad…
            </p>
            <a href="/docs/temario" style={btn('#1976d2')}>Abrir temario <span style={arrow}>→</span></a>
          </article>

          {/* Prácticas */}
          <article className="lift-card" style={cardStyle('#0a1930','#0d47a1','#1976d2')}>
            <div className="glow" style={glowStyle}></div>
            <span style={pill('#7dd3fc')}>Trabajo</span>
            <h3 style={title}>Prácticas</h3>
            <p style={desc}>
              Enunciados, entregas y rúbricas: ejercicios guiados y retos.
            </p>
            <a href="/docs/practicas/overview" style={btn('#1976d2')}>Ver prácticas <span style={arrow}>→</span></a>
          </article>

          {/* Recursos */}
          <article className="lift-card" style={cardStyle('#0a1930','#0d47a1','#1976d2')}>
            <div className="glow" style={glowStyle}></div>
            <span style={pill('#93c5fd')}>Extra</span>
            <h3 style={title}>Recursos</h3>
            <p style={desc}>
              Snippets, enlaces útiles, bibliografía y referencias.
            </p>
            <a href="/docs/recursos" style={btn('#1976d2')}>Abrir recursos <span style={arrow}>→</span></a>
          </article>
        </section>
...
const btnPrimary = {
  ...
  textDecoration:'none', color:'#0b1220', background:'#22d3ee',
  padding:'10px 14px', borderRadius:12, fontWeight:800,
  boxShadow:'0 6px 14px rgba(34,211,238,.35)'
};
const btnGhost = {
  display:'inline-flex', alignItems:'center', gap:8,
